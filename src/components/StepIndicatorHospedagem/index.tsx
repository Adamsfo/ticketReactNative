...
interface StepIndicatorHospedagemProps {
  currentStep: number;
}

const StepIndicatorHospedagem: React.FC<StepIndicatorHospedagemProps> = ({
  currentStep,
}) => {
  const steps = ["Reserva", "Conferência", "Pagamento"];
...
export default StepIndicatorHospedagem;
